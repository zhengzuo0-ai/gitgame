...
BODY=$(bash .claude/scripts/py.sh .claude/scripts/dice.py "$FAKE_SHA" 1 attr-body)
MIND=$(bash .claude/scripts/py.sh .claude/scripts/dice.py "$FAKE_SHA" 1 attr-mind)
EDGE=$(bash .claude/scripts/py.sh .claude/scripts/dice.py "$FAKE_SHA" 1 attr-edge)
LUCK=$(bash .claude/scripts/py.sh .claude/scripts/dice.py "$FAKE_SHA" 1 attr-luck)
...
BODY2=$(bash .claude/scripts/py.sh .claude/scripts/dice.py "$FAKE_SHA" 1 attr-body)
if [ "$BODY" != "$BODY2" ]; then
